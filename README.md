# 🏪 Data Warehouse Punta Fina - Sistema ETL
## Ingeniería de Datos para Data Warehouse Dimensional
...
Sistema ETL (Extract, Transform, Load) completo para **Punta Fina**, integrando datos de **OroCommerce**, **OroCRM** y archivos **CSV** en un Data Warehouse dimensional. Procesa más de 300,000 registros con validación automática y mantiene consistencia de datos.

**Período de Análisis:** Noviembre 2023 - Noviembre 2025

### ✨ Características Principales

- ✅ **Procesamiento Completo**: Más de 300,000 registros procesados
- ✅ **Múltiples Fuentes**: OroCommerce + OroCRM + CSV
- ✅ **14 Dimensiones**: Clientes, productos, fechas, usuarios, etc.
- ✅ **6 Tablas de Hechos**: Ventas, inventario, transacciones, etc.
- ✅ **Validación Automática**: Verifica coherencia y calidad
- ✅ **Consistencia de Datos**: Período nov-2023 a nov-2025
- ✅ **Logs Detallados**: Seguimiento completo del proceso
- ✅ **Documentación Completa**: Mapeo detallado de todas las tablas
...
- Genera la estructura de directorios necesaria
- Verifica la conexión a la base de datos

Luego **edita el archivo `.env`** con tus credenciales:
```env
# Base de datos origen (OroCommerce)
SOURCE_DB_HOST=localhost
SOURCE_DB_PORT=5432
SOURCE_DB_NAME=orocommerce
SOURCE_DB_USER=tu_usuario
SOURCE_DB_PASS=tu_password

# Data Warehouse destino
DW_DB_HOST=localhost
DW_DB_PORT=5432
DW_DB_NAME=datawarehouse_bi
DW_DB_USER=tu_usuario
DW_DB_PASS=tu_password
```

### 4. Validación

```bash
# Validar configuración y conexiones
