...
6. [dim_fecha](#7-dim_fecha)
7. [dim_usuario](#8-dim_usuario)
8. [dim_producto](#9-dim_producto)
9. [dim_cliente](#10-dim_cliente)
10. [dim_orden](#11-dim_orden)
11. [dim_promocion](#12-dim_promocion)
12. [dim_impuestos](#13-dim_impuestos)
13. [dim_almacen](#14-dim_almacen)
14. [dim_proveedor](#15-dim_proveedor)
15. [dim_tipo_movimiento](#16-dim_tipo_movimiento)
16. [dim_cuenta_contable](#17-dim_cuenta_contable)
17. [dim_centro_costo](#18-dim_centro_costo)
18. [dim_tipo_transaccion](#19-dim_tipo_transaccion)
19. [dim_periodo](#20-dim_periodo)
...
| tipo_movimiento | Tipo de movimiento contable | VARCHAR(10) | — | — | DEBITO o CREDITO según la naturaleza del asiento |
| monto | Monto de la transacción | NUMERIC(15,2) | oro_order | subtotal_value / total_value | Según tipo de asiento: total, subtotal, IVA o costo |
...
## 6cha_carga | Fecha de carga en DW | TIMESTAMP | — | — | Timestamp del momento de la carga ETL |
...
| tipo_orden | Tipo de orden | VARCHAR(50) | — | — | Categorización de la orden (venta, servicio, etc.) |
...
**Tipo de tabla:** Dimensión  
**Nombre:** dim_periodo (nombre real en BD: dim_periodo)  
